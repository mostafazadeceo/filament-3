...
namespace Haida\FilamentRestaurantOps\Filament\Resources\RestaurantGoodsReceiptResource\RelationManagers;
...
class GoodsReceiptLinesRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('tax_amount')->label('مالیات'),
            ]);
    }
