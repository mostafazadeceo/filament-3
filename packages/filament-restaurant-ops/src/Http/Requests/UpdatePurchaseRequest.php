...
class UpdatePurchaseRequest extends BaseRestaurantOpsRequest
{
    public function authorize(): bool
    {
        ...
        return $request
            ? auth()->user()?->can('update', $request) ?? false
            : auth()->user()?->can('update', RestaurantPurchaseRequest::class) ?? false;
    }
