...
class VatReportSubmitted implements AccountingEvent
{
    use Dispatchable;

    public function __construct(public VatReport $record) {}

    public function eventName(): string
    {
        return 'vat_report.submitted';
    }

    public function payload(): array
    {
        return [
            'event' => 'vat_report.submitted',
