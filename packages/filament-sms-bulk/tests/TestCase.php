...
namespace Haida\SmsBulk\Tests;

use Filamat\IamSuite\FilamatIamSuiteServiceProvider;
use Filamat\IamSuite\Support\TenantContext;
use Haida\SmsBulk\FilamentSmsBulkServiceProvider;
...
class TestCase extends BaseTestCase
{
    ...
    {
        return [
            FilamentSmsBulkServiceProvider::class,
    ...
    {
        $app['config']->set('auth.providers.users.model', \Haida\SmsBulk\Tests\Fixtures\User::class);
