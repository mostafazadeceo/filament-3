...
class StoreRedirectPolicy
{
    ...
    public function view(User $user, StoreRedirect $record): bool
    {
    ...
    public function update(User $user, StoreRedirect $record): bool
    {
        return IamAuthorization::allows('storebuilder.manage', IamAuthorization::resolveTenantFromRecord($record), $user);
    }

    public function delete(User $user, StoreRedirect $record): bool
    {
        return IamAuthorization::allows('storebuilder.manage', IamAuthorization::resolveTenantFromRecord($record), $user);
    }
}
