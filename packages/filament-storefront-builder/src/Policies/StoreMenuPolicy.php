...
class StoreMenuPolicy
{
    ...
    public function view(User $user, StoreMenu $record): bool
    {
    ...
    public function update(User $user, StoreMenu $record): bool
    {
        return IamAuthorization::allows('storebuilder.manage', IamAuthorization::resolveTenantFromRecord($record), $user);
    }

    public function delete(User $user, StoreMenu $record): bool
    {
        return IamAuthorization::allows('storebuilder.manage', IamAuthorization::resolveTenantFromRecord($record), $user);
    }
}
