...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create($table, function (Blueprint $blueprint): void {
            ...
            $blueprint->index(['client_id', 'expires_at'], 'iam_oidc_refresh_tokens_client_exp_idx');
            $blueprint->index(['user_id', 'tenant_id'], 'iam_oidc_refresh_tokens_user_tenant_idx');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('iam_oidc_refresh_tokens');
    }
};
