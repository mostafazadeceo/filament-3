...
class RoleController extends BaseController
{
    ...
    public function store(Request $request, ?int $parentId = null): Response
    {
        ...
        app(AuditService::class)->log('role.created', $item, ['reason' => $reason], $request->user());
    ...
    public function update(Request $request, int $id): Response
    {
        ...
        app(AuditService::class)->log('role.updated', $item, ['reason' => $reason], $request->user());
    ...
    public function destroy(int $id): Response
    {
        ...
        app(AuditService::class)->log('role.deleted', $item, ['reason' => $reason], $request->user());
