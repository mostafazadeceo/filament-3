...
class PayrollAllowanceTablePolicy
{
    ...
    public function view(PayrollAllowanceTable $table): bool
    {
    ...
    public function update(PayrollAllowanceTable $table): bool
    {
        return $this->allow('payroll.settings.manage', $table);
    }

    public function delete(PayrollAllowanceTable $table): bool
    {
        return $this->allow('payroll.settings.manage', $table);
    }
}
