...
class ChatConnectionPolicy
{
    public function viewAny(User $user): bool
    {
        return IamAuthorization::allows('chat.connection.view');
    }

    public function view(User $user, ChatConnection $record): bool
    {
        return IamAuthorization::allows('chat.connection.view', IamAuthorization::resolveTenantFromRecord($record));
    }
    ...
    public function update(User $user, ChatConnection $record): bool
    {
    ...
    public function delete(User $user, ChatConnection $record): bool
    {
        $tenant = IamAuthorization::resolveTenantFromRecord($record);
    ...
    protected function canManage(User $user, ?Tenant $tenant): bool
    {
        ...
        if (! IamAuthorization::allows('chat.connection.manage', $tenant, $user)) {
            return false;
        }
