...
namespace Haida\FilamentAppApi\Tests;

use Filamat\IamSuite\FilamatIamSuiteServiceProvider;
use Filamat\IamSuite\Support\TenantContext;
use Haida\FilamentAppApi\FilamentAppApiServiceProvider;
...
class TestCase extends BaseTestCase
{
    ...
    {
        return [
            FilamentAppApiServiceProvider::class,
    ...
    {
        $app['config']->set('auth.providers.users.model', \Haida\FilamentAppApi\Tests\Fixtures\User::class);
