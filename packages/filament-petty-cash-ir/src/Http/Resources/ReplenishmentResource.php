...
class ReplenishmentResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'approval_steps_required' => $this->approval_steps_required,
            'approval_steps_completed' => $this->approval_steps_completed,
            ...
            'reversal_journal_entry_id' => $this->reversal_journal_entry_id,
