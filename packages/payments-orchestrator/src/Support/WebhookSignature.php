...
class WebhookSignature
{
    ...
    public function verify(string $payload, array $headers, string $secret): bool
    {
        ...
        $timestampHeader = (string) config('payments-orchestrator.webhooks.timestamp_header', 'X-Timestamp');
        $tolerance = (int) config('payments-orchestrator.webhooks.tolerance_seconds', 300);
