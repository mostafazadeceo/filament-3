...
class CommerceCategoryPolicy
{
    ...
    public function view(User $user, CommerceCategory $record): bool
    {
        return IamAuthorization::allowsAny([
            'commerce.catalog.view',
            'commerce.catalog.manage',
    ...
    public function update(User $user, CommerceCategory $record): bool
    {
        return IamAuthorization::allows('commerce.catalog.manage', IamAuthorization::resolveTenantFromRecord($record), $user);
    }

    public function delete(User $user, CommerceCategory $record): bool
    {
        return IamAuthorization::allows('commerce.catalog.manage', IamAuthorization::resolveTenantFromRecord($record), $user);
    }

    public function restore(User $user, CommerceCategory $record): bool
    {
        return IamAuthorization::allows('commerce.catalog.manage', IamAuthorization::resolveTenantFromRecord($record), $user);
    }

    public function forceDelete(User $user, CommerceCategory $record): bool
    {
        return IamAuthorization::allows('commerce.catalog.manage', IamAuthorization::resolveTenantFromRecord($record), $user);
    }
}
