...
class CommerceProductPolicy
{
    ...
    public function view(User $user, CommerceProduct $record): bool
    {
        return IamAuthorization::allowsAny([
            'commerce.catalog.view',
            'commerce.catalog.manage',
    ...
    public function update(User $user, CommerceProduct $record): bool
    {
        return IamAuthorization::allows('commerce.catalog.manage', IamAuthorization::resolveTenantFromRecord($record), $user);
    }

    public function delete(User $user, CommerceProduct $record): bool
    {
        return IamAuthorization::allows('commerce.catalog.manage', IamAuthorization::resolveTenantFromRecord($record), $user);
    }

    public function restore(User $user, CommerceProduct $record): bool
    {
        return IamAuthorization::allows('commerce.catalog.manage', IamAuthorization::resolveTenantFromRecord($record), $user);
    }

    public function forceDelete(User $user, CommerceProduct $record): bool
    {
        return IamAuthorization::allows('commerce.catalog.manage', IamAuthorization::resolveTenantFromRecord($record), $user);
    }
}
