# INSTALL — filament-restaurant-ops
...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با FilamentRestaurantOpsPlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با FilamentRestaurantOpsPlugin::make() در TenantPanelProvider
...
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=filament-restaurant-ops-config`
## تست/اعتبارسنجی
