# INSTALL — providers-esim-go-commerce
...
## تنظیمات
- فایل‌های کانفیگ:
- packages/providers-esim-go-commerce/config/providers-esim-go-commerce.php
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=providers-esim-go-commerce-config`
## تست/اعتبارسنجی
