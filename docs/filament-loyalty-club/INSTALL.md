...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با FilamentLoyaltyClubPlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با FilamentLoyaltyClubPlugin::make() در TenantPanelProvider
...
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=filament-loyalty-club-config`
## تست/اعتبارسنجی
