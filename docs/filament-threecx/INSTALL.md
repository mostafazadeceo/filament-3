...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با FilamentThreeCxPlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با FilamentThreeCxPlugin::make() در TenantPanelProvider
