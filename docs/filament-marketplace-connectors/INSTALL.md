# INSTALL — filament-marketplace-connectors
...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با FilamentMarketplaceConnectorsPlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با FilamentMarketplaceConnectorsPlugin::make() در TenantPanelProvider
...
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=filament-marketplace-connectors-config`
## تست/اعتبارسنجی
