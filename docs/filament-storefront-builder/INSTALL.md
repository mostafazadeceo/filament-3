# INSTALL — filament-storefront-builder
...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با FilamentStorefrontBuilderPlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با FilamentStorefrontBuilderPlugin::make() در TenantPanelProvider
...
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=filament-storefront-builder-config`
## تست/اعتبارسنجی
