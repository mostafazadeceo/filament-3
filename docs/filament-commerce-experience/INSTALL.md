# INSTALL — filament-commerce-experience
...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با FilamentCommerceExperiencePlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با FilamentCommerceExperiencePlugin::make() در TenantPanelProvider
...
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=filament-commerce-experience-config`
## تست/اعتبارسنجی
