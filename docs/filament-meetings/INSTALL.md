...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: در صورت نیاز با FilamentMeetingsPlugin::make() در AdminPanelProvider ثبت شود
  - Tenant: ثبت شده با FilamentMeetingsPlugin::make() در TenantPanelProvider
...
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=filament-meetings-config`
## تست/اعتبارسنجی
