# INSTALL — filament-commerce-core
...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با FilamentCommerceCorePlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با FilamentCommerceCorePlugin::make() در TenantPanelProvider
...
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=filament-commerce-core-config`
## تست/اعتبارسنجی
