...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با RelogradePlugin::make() در AdminPanelProvider
  - Tenant: در صورت نیاز با RelogradePlugin::make() در TenantPanelProvider ثبت شود
