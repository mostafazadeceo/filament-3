...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با SiteBuilderCorePlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با SiteBuilderCorePlugin::make() در TenantPanelProvider
...
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=site-builder-core-config`
## تست/اعتبارسنجی
