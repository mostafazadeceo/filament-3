...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با ContentCmsPlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با ContentCmsPlugin::make() در TenantPanelProvider
...
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=content-cms-config`
## تست/اعتبارسنجی
