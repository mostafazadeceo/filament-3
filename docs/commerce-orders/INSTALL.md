...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با CommerceOrdersPlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با CommerceOrdersPlugin::make() در TenantPanelProvider
...
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=commerce-orders-config`
## تست/اعتبارسنجی
