# INSTALL — filament-petty-cash-ir
...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با FilamentPettyCashIrPlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با FilamentPettyCashIrPlugin::make() در TenantPanelProvider
