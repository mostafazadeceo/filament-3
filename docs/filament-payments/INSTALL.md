...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با FilamentPaymentsPlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با FilamentPaymentsPlugin::make() در TenantPanelProvider
