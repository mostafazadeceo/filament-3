# INSTALL — filament-accounting-ir
...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با FilamentAccountingIrPlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با FilamentAccountingIrPlugin::make() در TenantPanelProvider
...
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=filament-accounting-ir-config`
## تست/اعتبارسنجی
