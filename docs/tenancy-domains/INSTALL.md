...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با TenancyDomainsPlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با TenancyDomainsPlugin::make() در TenantPanelProvider
...
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=tenancy-domains-config`
## تست/اعتبارسنجی
