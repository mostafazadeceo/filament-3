# INSTALL — filament-providers-esim-go
...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با ProvidersEsimGoPlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با ProvidersEsimGoPlugin::make() در TenantPanelProvider
...
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=filament-providers-esim-go-config`
## تست/اعتبارسنجی
