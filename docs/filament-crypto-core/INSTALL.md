...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با FilamentCryptoCorePlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با FilamentCryptoCorePlugin::make() در TenantPanelProvider
...
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=filament-crypto-core-config`
## تست/اعتبارسنجی
