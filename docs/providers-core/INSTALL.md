...
- اگر پکیج Plugin دارد، ثبت در پنل‌ها:
  - Admin: ثبت شده با ProvidersCorePlugin::make() در AdminPanelProvider
  - Tenant: ثبت شده با ProvidersCorePlugin::make() در TenantPanelProvider
...
- انتشار تنظیمات (در صورت نیاز):
  - `php artisan vendor:publish --tag=providers-core-config`
## تست/اعتبارسنجی
